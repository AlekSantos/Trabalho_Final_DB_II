...
\title{Trabalho Final de Banco de Dados II}

\author{Alekssander S. C. Martins\inst{1}, Fabio N. Patão\inst{1}, Vitória M. C. Chaves\inst{1}}
...
A configuração do ambiente de desenvolvimento está centralizada em `docker-compose.yml`. A Tabela~\ref{tab:config} resume as definições e parâmetros essenciais adotados na montagem do cluster.
...
\begin{tabular}{lcrr}
\toprule
\textbf{Fase do Teste} & \textbf{Disponibilidade} & \textbf{Resultados} & \textbf{Tempo de Resposta (ms)} \\
\midrule
